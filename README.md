...
<svg fill="none" viewBox="0 0 600 400" width="600" height="400" xmlns="http://www.w3.org/2000/svg">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class='body'>
      <div class='container'>
        <h1>
          <a href="https://github.com/MinhQuyenT">
            <span><em>Minh Quyen</em></span>
          </a>
        </h1>
        <section class='items'>
          <ul>
          ...
          <ul>
            <li>Software Engineer at <a href="https://www.topcv.vn/xem-cv/BABRXgZUAgYHVlNWA1MCVABRVw1RVVUGBgBSCA116e">Toptal</a></li>
          </ul>
          <ul>
            <li>Organizer at <a href="https://novisadjs.org">Novi Sad JS</a></li>
          </ul>
          <ul>
            <li><a href="mailto:tmquyenit@gmail.com" role="button"><span class='hi'>👋</span></a></li>
          </ul>
        </section>
      </div>
    </div>
